...
class GcamDataSystem(object):
    ...
    def __init__(self, sim, scenario, renv_dir=None, xml_modifier=None):
        """
    ...
    def load_gcamdata(self):
        ...
        _logger.debug(f"Calling load_all('{self.sim.ref_gcamdata_dir}')")
        devtools.load_all(self.sim.ref_gcamdata_dir)
    ...
    def trial_sandbox(self, trial_num, delete=True):
        ...
        gcamdata_dir = self.sim.ref_gcamdata_dir
    ...
    def run_data_system(self, trials, user_modifications):
        ...
        if user_modifications is None:
            self.run_drake(self.sim.ref_gcamdata_dir)
            return
