...
TECH_OUTPUT_FILE = 'cement_tech_template.csv'
ELEC_OUTPUT_FILE = 'cement_elec_template.csv'

class CementCommand(SubcommandABC):

    def __init__(self, subparsers):
        kwargs = {'help' : '''Dump combinations of cement energy use sectors, techs, and fuels.'''}
        super(CementCommand, self).__init__('cement', subparsers, kwargs, group='project')
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument('-o', '--outputFile', default=None,
                            help=clean_help('''The CSV file to create with lists of unique cement sectors, 
    ...
    def run(self, args, tool):
        ...
        main_xml_file = 'cement.xml'
        #Not configured to work for GCAM-USA correctly
        usa_xml_file = 'cement.xml'
