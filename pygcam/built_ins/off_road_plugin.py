...
TECH_OUTPUT_FILE = 'off_road_tech_template.csv'
ELEC_OUTPUT_FILE = 'off_road_elec_template.csv'

class OffRoadCommand(SubcommandABC):

    def __init__(self, subparsers):
        kwargs = {'help' : '''Dump combinations of off_road energy use sectors, techs, and fuels.'''}
        super(OffRoadCommand, self).__init__('off_road', subparsers, kwargs, group='project')
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument('-o', '--outputFile', default=None,
                            help=clean_help('''The CSV file to create with lists of unique off_road sectors, 
    ...
    def run(self, args, tool):
        ...
        main_xml_file = 'off_road.xml'
        #Not configured to work for GCAM-USA correctly
        usa_xml_file = 'off_road.xml'
