...
TECH_OUTPUT_FILE = 'iron_steel_tech_template.csv'
ELEC_OUTPUT_FILE = 'iron_steel_elec_template.csv'

class IronSteelCommand(SubcommandABC):

    def __init__(self, subparsers):
        kwargs = {'help' : '''Dump combinations of iron and steel energy use sectors, techs, and fuels.'''}
        super(IronSteelCommand, self).__init__('iron_steel', subparsers, kwargs, group='project')
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument('-o', '--outputFile', default=None,
                            help=clean_help('''The CSV file to create with lists of unique iron and steel sectors, 
    ...
    def run(self, args, tool):
        ...
        main_xml_file = 'iron_steel.xml'
        #Not configured to work for GCAM-USA correctly
        usa_xml_file = 'iron_steel.xml'
