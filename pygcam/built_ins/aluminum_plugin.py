...
TECH_OUTPUT_FILE = 'aluminum_tech_template.csv'
ELEC_OUTPUT_FILE = 'aluminum_elec_template.csv'

class AluminumCommand(SubcommandABC):

    def __init__(self, subparsers):
        kwargs = {'help' : '''Dump combinations of aluminum energy use sectors, techs, and fuels.'''}
        super(AluminumCommand, self).__init__('aluminum', subparsers, kwargs, group='project')
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument('-o', '--outputFile', default=None,
                            help=clean_help('''The CSV file to create with lists of unique aluminum sectors, 
    ...
    def run(self, args, tool):
        ...
        main_xml_file = 'aluminum.xml'
        #Not configured to work for GCAM-USA correctly
        usa_xml_file = 'aluminum.xml'
