...
TECH_OUTPUT_FILE = 'chemical_tech_template.csv'
ELEC_OUTPUT_FILE = 'chemical_elec_template.csv'

class ChemicalCommand(SubcommandABC):

    def __init__(self, subparsers):
        kwargs = {'help' : '''Dump combinations of chemical energy use sectors, techs, and fuels.'''}
        super(ChemicalCommand, self).__init__('chemical', subparsers, kwargs, group='project')
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument('-o', '--outputFile', default=None,
                            help=clean_help('''The CSV file to create with lists of unique chemical sectors, 
    ...
    def run(self, args, tool):
        ...
        main_xml_file = 'chemical.xml'
        #Not configured to work for GCAM-USA correctly
        usa_xml_file = 'chemical.xml'
