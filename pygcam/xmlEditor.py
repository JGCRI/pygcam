...
class XMLEditor(object):
    ...
    """
    def __init__(self, sbx : Sandbox, parent=None, cleanXML=True):
        ...
        # TBD: use GcamPath in Sandbox and reference here
        self.scenario_dir_abs = makeDirPath(self.local_xml_abs, group, scenario, create=True)
        self.scenario_dir_rel = pathjoin(self.local_xml_rel, group, scenario)

        # Get baseline from ScenarioGroup and use ScenarioInfo API to get this type of info
        self.baseline_dir_rel = pathjoin(self.local_xml_rel, group, self.parent.name) if self.parent else None

        # Store commonly-used paths
        gcam_xml = 'input/gcamdata/xml'
        self.gcam_prefix_abs = pathjoin(sbx.ref_workspace, gcam_xml)
