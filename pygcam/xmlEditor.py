...
class XMLEditor(object):
    ...
    """
    def __init__(self, sbx : Sandbox, cleanXML=True):
        ...
        # self.solution_prefix_abs = pathjoin(sbx.ref_workspace, "input", "solution")
        ...
        if cleanXML and scenario and sbx.mcs_mode != McsMode.TRIAL:
    ...
    def setupDynamic(self, args):
        ...
        dynDir = sbx.sandbox_dynamic_xml
    ...
    def setupStatic(self, args):
        ...
        topDir = sbx.project_scenario_xml_src
    ...
    def addMarketConstraint(self, target, policy, dynamic=False):
        ...
        **Callable from XML setup files.**
        ...
        policyReldir = self.sbx.baseline_scenario_xml or reldir
